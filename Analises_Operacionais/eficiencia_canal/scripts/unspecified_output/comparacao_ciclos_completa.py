...
# Carregar análise do dia 30 para comparar
...
ciclos_defs = {
    '23.1': (pd.Timestamp('2023-05-01'), pd.Timestamp('2023-10-31')),
    '24.1': (pd.Timestamp('2023-11-01'), pd.Timestamp('2024-04-30')),
    '25.1': (pd.Timestamp('2024-05-01'), pd.Timestamp('2024-10-31')),
    '26.1': (pd.Timestamp('2024-11-01'), pd.Timestamp('2025-04-30')),
}
